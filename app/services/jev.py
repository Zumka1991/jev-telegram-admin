...
_NUANCES: dict[str, str] = {
    ...
    "insult": (
        ...
        "Нейтральная оценка уровня навыка («новичок», «начинающий») и конструктивный "
        "совет учиться, тренироваться или стать профессионалом НЕ являются оскорблением "
        "без насмешки, уничижительного эпитета или враждебного тона. "
    ),
    "bullying": (
        "Буллинг требует, чтобы сам target_message содержал направленное враждебное "
        "давление, унижение, угрозу или насмешку. Нейтральная оценка уровня навыка "
        "(«новичок», «начинающий») и совет учиться или совершенствоваться НЕ являются "
        "буллингом. Не переноси агрессию из recent_context на нейтральное сообщение и "
        "не считай новое обращение продолжением травли только из-за прошлых реплик. "
    ),
    "trolling": (
        ...
        "троллингом не являются. Нейтральная оценка уровня навыка («новичок», "
        "«начинающий») и конструктивный совет учиться или совершенствоваться тоже "
        "не являются провокацией без насмешки или враждебного контекста в самой реплике. "
    ),
}
